...
if (isset($_SESSION['usuario']) && isset($_SESSION['nombre'])) {
    ...
    $folio = $_POST['folio_cajachica'] ?? null;    
    $fecha_almacen = $_POST['fecha_cajachica'] ?? null;
    $cantidad_entrada = $_POST['cantidad_cajachica'] ?? null;
    $establecimiento= $_POST['establecimiento_cajachica'] ?? null;
    $factura= $_POST['factura_cajachica'] ?? null;
    $observaciones= $_POST['observaciones_cajachica'] ?? null;             
    $entradalma="A";  
    $entrada="E"; 
    $cajachica="C";
    $presta="P";
...
$sql = "INSERT INTO histor (
    ...
    EXISTENCIA, NO_VALE, ALMACEN, CAJACHICA, ENTRADA, NUMEXP, NOMBRE, 
    ...
    '$cajachica', '$entrada', '$expediente_usuario', '$nombre_usuario', 
