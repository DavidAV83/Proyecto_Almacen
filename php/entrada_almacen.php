...
if ($codigo = $_SESSION['codigo']) {   
    ...
    $sql = "SELECT EXISTENCIA, DESCRIPCIO, COSTO, UNI_MED, CANSAL, FECHASAL, FECHA, CATEGO, FOLIO, CANTIDAD, COSTO, FACTURA, OBSERVA, ESTABLE, SECC FROM histor WHERE CODIGO = '$codigo' ORDER BY ID DESC LIMIT 1";
