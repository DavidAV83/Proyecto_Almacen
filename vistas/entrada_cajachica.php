...
<div class="form-container_2">                   
	    ...
	    <input type="date" id="fecha_cajachica" name="fecha_cajachica">
        </div>
        
        <div class="form-group">
            <label for="cantidad_cajachica">CANTIDAD: </label>
            <input type="text" id="cantidad_cajachica" name="cantidad_cajachica">
        </div>
        
        <div class="form-group">
            <label for="establecimiento_cajachica">ESTABLECIMIENTO:</label>
            <input type="text" id="establecimiento_cajachica" name="establecimiento_cajachica">
        </div>

	<div class="form-group">
            <label for="factura_cajachica">FACTURA:</label>
            <input type="text" id="factura_cajachica" name="factura_cajachica">
        </div>

	<div class="form-group">
            <label for="observaciones_cajachica">OBSERVACIONES:</label>
            <input type="text" id="observaciones_cajachica" name="observaciones_cajachica">
        </div>
	</form>
</div> 
...
<p id="mensaje"></p>
    ...
    <script>
        function enviarDatos() {           
            ...
            fetch('../php/entrada_cajachica.php', {
                method: 'POST',
                body: formData
            })
