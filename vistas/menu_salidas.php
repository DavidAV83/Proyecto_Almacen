...
<body >
    ...
    <div class="contenedor_botones">
      <button name="btn_entregado_trabajador" class="estilo_botones"><h2>ENTREGADO A TRABAJADOR</h2></button><br><br>
      <button name="btn_prestamo_oa"  class="estilo_botones"><h2>PRESTAMO A OTRA ÁREA</h2></button><br><br>
      <button name="btn_devuelto_almacen" class="estilo_botones"><h2>DEVUELTO AL ALMACÉN</h2></button>
    </div>
