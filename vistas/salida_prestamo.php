...
<body>
    ...
    <div class="formulario_salida_dos">
        <form id="formSalida" action="">
            ...
            <br><br>
            <div class="seleccion">
                <label for="area_p">ÁREA DE DESTINO: </label>
                <select name="area_p" id="area_p" required>
                    <option value="" disabled selected>SELECCIONA UNA ÁREA</option>
                </select>
            </div>
            <br><br>
            <label for="persona_recibe">NOMBRE DE LA PERSONA QUE RECIBE: </label><input type="text"
                name="persona_recibe" id="persona_recibe" required>
            <br><br>
            <label for="persona_entrega">NOMBRE DE LA PERSONA QUE ENTREGA: </label><input type="text"
                name="persona_entrega" id="persona_entrega" required>
            <br><br>
    ...
    <div class="formulario_salida_tres">
        <form action="">
    ...
    <script>
        ...
        document.querySelector('button[name="guardar"]').addEventListener('click', function () {
            ...
            if (confirm('¿Estás seguro(a) de guardar estos datos?')) {
                ...
                fetch('../php/guardar_datos_pres.php', {
                    method: 'POST',
                    body: formData
                })
                    .then(response => response.json())
